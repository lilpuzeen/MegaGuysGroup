...
# # 39763
# def task_1():
# 	arr = [int(x) for x in open('/Users/armantovmasyan/PycharmProjects/MegaGuysGroup/HW_completed/Grisha_Manosyev/service_files/39763.txt')]
# 	count = 0
# 	maxx = float('-inf')
...
# # 37344
# def task_2():
# 	arr = [int(x) for x in open('/Users/armantovmasyan/PycharmProjects/MegaGuysGroup/HW_completed/Grisha_Manosyev/service_files/37344.txt')]
# 	count = 0
# 	maxx = float('-inf')
...
# # 37354
# def task_3():
# 	arr = [int(x) for x in open('/Users/armantovmasyan/PycharmProjects/MegaGuysGroup/HW_completed/Grisha_Manosyev/service_files/37354.txt')]
# 	count = 0
# 	maxx = float('-inf')
# 	for i in range(len(arr)):
# 	    for j in range(i + 1, len(arr)):
...
# # 47221
# def task_4():
# 	arr = [int(x) for x in open('/Users/armantovmasyan/PycharmProjects/MegaGuysGroup/HW_completed/Grisha_Manosyev/service_files/47221.txt')]
# 	count = 0
# 	maxx = float('-inf')
