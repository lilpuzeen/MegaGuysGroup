...
# 1 задание
# 39763
# arr = [int(x) for x in open('service_files/39763.txt')]
# count = 0
# maxx = float('-inf')
...
# 2 задание
# 37344
# arr = [int(x) for x in open('service_files/37344.txt')]
# count = 0
# maxx = float('-inf')
...
# 3 задание
# 37354
# arr = [int(x) for x in open('service_files/37354.txt')]
# count = 0
# maxx = float('-inf')
# for i in range(len(arr)):
#     for j in range(i + 1, len(arr)):
...
# 4 задание
# 47221
# arr = [int(x) for x in open('service_files/47221.txt')]
# count = 0
# maxx = float('-inf')
